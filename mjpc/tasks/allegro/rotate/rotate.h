...
#ifndef MJPC_TASKS_ALLEGRO_ROTATE_H_
#define MJPC_TASKS_ALLEGRO_ROTATE_H_
...
class Rotate : public Task {
 public:
  ...
  class ResidualFn : public BaseResidualFn {
   public:
    explicit ResidualFn(const Rotate *task) : BaseResidualFn(task) {}
    void Residual(const mjModel *model, const mjData *data,
                  double *residual) const override;
  };
  Rotate() : residual_(this) {}
...
#endif  // MJPC_TASKS_ALLEGRO_ROTATE_H_
